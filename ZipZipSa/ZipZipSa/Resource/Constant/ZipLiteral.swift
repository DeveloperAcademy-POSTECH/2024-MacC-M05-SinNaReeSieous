...
enum ZipLiteral {
    ...
    enum RoomScanInfo {
        ...
        static let description1: String = "아이폰 내장 기술인 RoomPlan을 사용해"
        static let description2: String = "집의 구조를 기록할 거예요."
        static let description3: String = "3d 모델 형태로 집 구조가 제공되며,"
        static let description4: String = "이 과정에서 사진 정보는 기록되지 않아요."
    ...
    enum UnsupportedDevice {
        static let title1: String = "집 구조 기록을"
        static let title2: String = "지원하지 않는 기기예요"
        static let description1: String = "현재 RoomPlan 기능은"
        static let description2: String = "iPhone Pro 및 Pro Max 모델에서만 지원됩니다."
        static let description3: String = "바로 결과지를 보러 가볼까요?"
